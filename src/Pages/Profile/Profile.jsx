        ...
        <div class="mt-10 w-full md:w-3/4">
          <div class="px-4 py-5 sm:px-6">
            <h3 class="text-lg leading-6 font-medium text-gray-900 inline-flex">
              <Identification className="w-5 h-5 text-black mr-2 my-1" /> User
              Info
            </h3>
          </div>
          <div className="flex justify-center items-center">
            <img
              ...
              className="rounded-full shadow-md size-40 mb-2"
            />
          </div>
            ...
            <dl>
              <div className="gray-row">
                <dt class="table-font-style-left">
                  <UserCircle className="w-4 h-4 text-black mr-2" />
                  Username
                </dt>
                <dd class="table-font-style-right">{user.username}</dd>
              </div>
              <div class="white-row">
                <dt class="table-font-style-left">
              ...
              <div className="gray-row">
                <dt class="table-font-style-left">
                  <Envelope className="w-4 h-4 text-black mr-2" />
                  Email
                </dt>
                <dd class="table-font-style-right">{user.email}</dd>
              </div>
              <div class="white-row">
                <dt class="table-font-style-left">
                ...
                <dd class="table-font-style-right">{user.phone}</dd>
              </div>
              <div className="gray-row">
                <dt class="table-font-style-left">
